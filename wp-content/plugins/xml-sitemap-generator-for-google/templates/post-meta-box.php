...
<div class="pro-wrapper <?php echo esc_attr( sgg_pro_class() ); ?>">
	...
	<table class="wp-list-table widefat fixed striped">
		<tr>
			<td>
				<label for="_sitemap_exclude"><?php esc_html_e( 'Exclude from Sitemap', 'xml-sitemap-generator-for-google-pro' ); ?></label>
			</td>
			<td>
		...
		<tr>
			<td>
				<label for="_sitemap_priority"><?php esc_html_e( 'Post Priority', 'xml-sitemap-generator-for-google-pro' ); ?></label>
			</td>
			<td>
				<select name="_sitemap_priority" id="_sitemap_priority" <?php disabled( ! sgg_pro_enabled() ); ?>>
					<option value=""><?php esc_html_e( 'Default', 'xml-sitemap-generator-for-google-pro' ); ?></option>
		...
		<tr>
			<td>
				<label for="_sitemap_frequency"><?php esc_html_e( 'Post Frequency', 'xml-sitemap-generator-for-google-pro' ); ?></label>
			</td>
			<td>
				<select name="_sitemap_frequency" id="_sitemap_frequency" <?php disabled( ! sgg_pro_enabled() ); ?>>
					<option value=""><?php esc_html_e( 'Default', 'xml-sitemap-generator-for-google-pro' ); ?></option>
					<option value="always" <?php selected( $frequency, 'always' ); ?>><?php esc_html_e( 'Always', 'xml-sitemap-generator-for-google-pro' ); ?></option>
					<option value="hourly" <?php selected( $frequency, 'hourly' ); ?>><?php esc_html_e( 'Hourly', 'xml-sitemap-generator-for-google-pro' ); ?></option>
					<option value="daily" <?php selected( $frequency, 'daily' ); ?>><?php esc_html_e( 'Daily', 'xml-sitemap-generator-for-google-pro' ); ?></option>
					<option value="weekly" <?php selected( $frequency, 'weekly' ); ?>><?php esc_html_e( 'Weekly', 'xml-sitemap-generator-for-google-pro' ); ?></option>
					<option value="monthly" <?php selected( $frequency, 'monthly' ); ?>><?php esc_html_e( 'Monthly', 'xml-sitemap-generator-for-google-pro' ); ?></option>
					<option value="yearly" <?php selected( $frequency, 'yearly' ); ?>><?php esc_html_e( 'Yearly', 'xml-sitemap-generator-for-google-pro' ); ?></option>
					<option value="never" <?php selected( $frequency, 'never' ); ?>><?php esc_html_e( 'Never', 'xml-sitemap-generator-for-google-pro' ); ?></option>
				</select>
			</td>
		</tr>
	</table>
